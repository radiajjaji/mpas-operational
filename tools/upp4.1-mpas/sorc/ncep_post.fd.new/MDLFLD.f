...
!    
      ...
      use ctlblk_mod, only: jsta_2l, jend_2u, lm, jsta, jend, grib, cfld, datapd,&
              ...
              me, dt, avrain, theat, ifhr, ifmin, avcnvc, lp1, im, jm, NBIN_DU,smflag
...
!
      integer I,J,K,L,Lctop,LLMH,IICE,LL,II,JJ,IFINCR,ITHEAT,NC,NMOD,LLL  &
...
!$omp parallel do private(i,j)
              DO J=JSTA,JEND
               ...
               ENDDO
               GRID1(I,J) = MAX(REFD_MAX(I,J),GRID1(I,J))
               ENDDO
              ENDDO
        ELSE
