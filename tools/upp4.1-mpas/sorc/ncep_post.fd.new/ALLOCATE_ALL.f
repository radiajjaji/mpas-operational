...
!
      ...
      allocate(erod(im,jsta_2l:jend_2u,3))
...
! GSDstart
      ...
      allocate(plume(im,jsta_2l:jend_2u,lm))
! GSDend
...
! vrbls3d
        ...
        allocate(tot_dust(im,jsta_2l:jend_2u,lm))
! vrbls2d
        allocate(vis_dust(im,jsta_2l:jend_2u))
        allocate(tot_edust(im,jsta_2l:jend_2u))
