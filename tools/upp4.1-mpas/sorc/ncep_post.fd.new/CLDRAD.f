...
!     INDEX FOR TOTAL AND SPECIATED AEROSOLS (DU, SS, SU, OC, BC)
      ...
      REAL, DIMENSION(IM,jsta:jend) :: FLTCND
...
!
          IF (AerosolName(i) .EQ. 'DUST') nbin = nbin_du-4
...
!$omp parallel do private(i,j)
         DO J = JSTA,JEND
            DO I = 1,IM
               GRID1(I,J) = DUEM(I,J,1) 
               DO K=2,NBIN_DU
                GRID1(I,J) = GRID1(I,J) + DUEM(I,J,K)
               END DO
            END DO
         END DO
         ID(1:25) = 0
...
!$omp parallel do private(i,j)
         DO J = JSTA,JEND
            DO I = 1,IM
               GRID1(I,J) = DUSD(I,J,1)
               DO K=2,NBIN_DU
                GRID1(I,J) = GRID1(I,J)+ DUSD(I,J,K)
               END DO
            END DO
         END DO
         ID(1:25) = 0
...
!$omp parallel do private(i,j)
         DO J = JSTA,JEND
            DO I = 1,IM
               GRID1(I,J) = DUSMASS(I,J) * 1.2 !ug/m3 
            END DO
         END DO
         ID(1:25) = 0
         ID(02)=129
...
!$omp parallel do private(i,j)
         DO J = JSTA,JEND
            DO I = 1,IM
               GRID1(I,J) = DUSMASS25(I,J) * 10E-3 ! mg/m3 
            END DO
         END DO
         ID(1:25) = 0
         ID(02)=129
